            ...
            {!isOnline && (
                ...
                >
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-black text-primary uppercase tracking-wider mb-2">Connection Lost</h2>
                        <p className="text-muted-foreground">You are currently offline. Please check your internet connection.</p>
                    </div>
